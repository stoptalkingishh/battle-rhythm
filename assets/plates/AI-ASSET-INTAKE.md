...
The intake directory must be flat. It may contain any subset of the 46 IDs from `assets/plates/workout-cards.json` — only approved IDs need to be present at each run. For each supplied ID, provide:
